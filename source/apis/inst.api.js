...
export class InstApi{
    ...
    statistics(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'inst/statistics',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
    ...
    zhenque(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'inst/zhenque',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
